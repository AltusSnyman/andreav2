---
name: ui-ux-pro-max
description: "UI/UX design intelligence for Antigravity. 50 styles, 21 palettes, 50 font pairings, 20 charts, 9 stacks. Actions: plan, build, create, design, implement, review, fix, improve. Suggests design systems based on product type."
---

# UI/UX Pro Max - Design Intelligence (Antigravity Edition)
...
Search specific domains using the python script below.
